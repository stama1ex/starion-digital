...
export const AR_STABILIZER = {
  ...
  // ширины маркера (0.004 ≈ 0.4 % от его ширины) и в радианах (~0.35°).
  posDeadzone: 0.004,
  rotDeadzone: 0.006,
  // Насколько быстро контент догоняет маркер. Доля от 0 до 1 на кадр: 0.18 —
  ...
  // как обрыв. 18 кадров ≈ 0.3 с: глаз не замечает, а мигание пропадает.
  holdFrames: 18,
};
