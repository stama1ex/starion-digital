...
export const AR_STABILIZER = {
  ...
  boostFast: 6,
  boostSlow: 3,
  // Видео лежит в плоскости маркера: гомография кладёт его точно, и
  // сглаживать там почти нечего — любое запаздывание читается как сползание с
  // сувенира. Поэтому у плоского контента все коэффициенты выше.
  videoFollow: 0.55,
  videoSwing: 0.7,
  videoDepth: 0.7,
