...
export const AR_STABILIZER = {
  ...
  followMax: 1,
  speedGain: 14,
  // Насколько движение ускоряет следование. Для надёжной части позы разгон
  // сильный — иначе контент отстаёт от руки. Для наклона и глубины он должен
  // быть слабым: там «движение» наполовину состоит из шума, и сильный разгон
  // просто пропускает этот шум обратно, сводя сглаживание на нет.
  boostFast: 6,
  boostSlow: 1.5,
