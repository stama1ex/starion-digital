...
// В базе путь к файлу хранится с пометкой хранилища: 'r2:products/...'.
// Пометка осталась с переезда, когда файлы какое-то время лежали в двух
// местах сразу, и позволяет отличить их от статики в public/.
