...
//
// Зачем оно: у R2 бесплатная раздача и постоянные адреса у файлов. Браузер
// качает их напрямую, минуя наш сервер, поэтому трафик к людям нам ничего
// не стоит, а на отрисовке страниц не остаётся ожидания чужого API.
//
...
// Прямая запись с сервера — так грузятся картинки товаров и бэкапы базы.
